...
namespace Telegram.Api.TL.Methods.Account
{
	...
	public
#endif
	partial class ITLAccountRegisterDevice : ITLObject, TLAccountRegisterDevice
	{
		public Int32 TokenType { get; set; }
		public String Token { get; set; }

		public ITLAccountRegisterDevice() { }
		public ITLAccountRegisterDevice(TLBinaryReader from)
		{
			Read(from);
		}
	...
	public partial interface TLAccountRegisterDevice : TLObject
	{
