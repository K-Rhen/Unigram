...
namespace Telegram.Api.TL
{
	...
	public
#endif
	partial class ITLPageBlockBlockquote : ITLPageBlockBase, TLPageBlockBlockquote 
	{
		public TLRichTextBase Text { get; set; }
		public TLRichTextBase Caption { get; set; }

		public ITLPageBlockBlockquote() { }
		public ITLPageBlockBlockquote(TLBinaryReader from)
		{
			Read(from);
		}
	...
	public partial interface TLPageBlockBlockquote : TLPageBlockBase
	{
